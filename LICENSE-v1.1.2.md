...
1.4. **"Contributor"** means an individual, Legal Entity, or operator of an
     ...
     Software or a Derivative Work. Making a Contribution does not, by
     itself, confer Guild membership, governance rights, or royalty
     entitlement unless the License Steward has expressly granted such
     status. A Contributor retains copyright in their accepted Contributions
     subject to the grants in this License.
...
1.4.1. **"AI Agent"** means any non-human system, including but not limited
     ...
     creative output. AI Agents are not Legal Entities and cannot hold
     copyright, serve as License Stewards, hold Guild membership, or
     exercise any rights under this License. Where an AI Agent produces
     a Contribution, the human individual or Legal Entity that directed,
     deployed, or caused the AI Agent to produce the Contribution is
     deemed the contributor of record for all purposes under this License.
...
1.4.3. **"Guild Member"** means an individual or Legal Entity that has been
     ...
     AI Agents may not be Guild Members. Guild Membership is distinct from
     Contributor and Collaborator status; a Guild Member may also be a
     Contributor and/or Collaborator, but a Contributor or Collaborator
     is not automatically a Guild Member.

1.5. **"Total Workforce"** means, for any Legal Entity, the total number of
     individuals, contractors, consultants, gig workers, temporary workers,
     AI Agents functioning as workers, and other persons or systems engaged
     in productive work on behalf of that entity, whether directly
     employed or engaged under any other arrangement. For purposes of
     ...
     obtaining a lower fee tier constitutes a material breach of this License.
     For the avoidance of doubt, "Total Workforce" supersedes any reference
     to "employee count" in this License.
...
1.6. **"Contribution"** means any work of authorship, including the original
     ...
     individual or Legal Entity. The act of submitting a pull request,
     filing an issue, or providing feedback without an express grant of
     copyright does not, by itself, constitute a Contribution for purposes
     of copyright under this License.
...
for that Derivative Work under this License, AND the total revenue derived
from the Derivative Work equals or exceeds the de minimis threshold published
by the License Steward in the Project Registry, or (where no threshold is
published) the equivalent of the greater of: (i) the smallest commercial
fee tier published in the Project Registry, or (ii) one hundred US dollars
(USD 100) or its equivalent in stablecoin at the time of evaluation, in any
...
(a) The License Steward of the original Software must receive a proportional
    ...
    ten percent (10%) of Derivative Work royalties, unless the Steward has
    approved a different percentage;
...
hereby grants to You, through the License Steward, a copyright license to
...
### 10.4 Damages for Unlicensed Use
Any unlicensed use of the Software constitutes copyright infringement and
subject the infringing party to the License Steward's claim for actual
damages, disgorgement of profits attributable to the unlicensed use, or
statutory damages to the maximum extent permitted under applicable law, at
the License Steward's election. For willful violations -- defined as use of
the Software with knowledge that a License Record was required and not
obtained -- the License Steward may seek enhanced damages up to three (3)
times the applicable License fee for the period of unauthorized use. For
the avoidance of doubt, "economic benefit" in any claim under this Section
shall be calculated proportionally to the Software's contribution to the
infringing party's product or service, using industry-standard attribution
methods, and shall in no case exceed ten (10) times the applicable License
fee. Repeat violations (two or more prior terminations) are presumed
willful.
...
Steward's governing jurisdiction, or in the courts of the Licensee's
domicile if the License Steward elects to enforce there.
...
**and** the number of Active Contributors -- defined as individuals who
have made a Contribution, commented on an Issue, or participated in
governance within the preceding twelve (12) months -- has fallen below
three (3), the restrictions in Sections 3, 4, and 5 regarding the Software
shall automatically lift, and the Software shall be considered licensed
under the terms of the **Apache License, Version 2.0**. For solo Stewards,
"governance" includes publication of fee schedules, changelog, or public
statements regarding the Software's maintenance status.
...
Steward. A valid report must provide evidence of: (a) Unauthorized
Commercial Use; (b) Unauthorized AI Training Use; or (c) Failure to
