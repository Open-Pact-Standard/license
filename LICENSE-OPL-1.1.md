> **Note:** This is **OPL-1.1**, which has been **superseded by OPL-1.2** (the recommended version). It is preserved here for existing adopters. New projects should adopt OPL-1.2; see `LICENSE.md` for the current text. There is no forced migration.
>
> See `CHANGELOG.md` for what changed and how to migrate.
